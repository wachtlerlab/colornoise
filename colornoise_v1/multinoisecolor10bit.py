    ...
    def run_session(self):
        ...
        if isinstance(stairs, data.MultiStairHandler):
            ...
            for rot, cond in stairs:
                ...
                judge, react_time, trial_time_start = self.run_trial(rot, cond, cond['std'], count)
...
"""Example"""
# run_exp(subject='psuedo', par_file_path=['config/cn2x8_LL_c.yaml'], cfg_file_path='config/expconfig_8bit.yaml')
