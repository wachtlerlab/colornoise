...
def displaycolor(rgb):
    win = visual.Window(size=[400, 400], allowGUI=True, bpc=(10, 10, 10), depthBits=10, color=rgb, colorSpace="rgb")
    win.flip()
    print(win.color)
    event.waitKeys()
    win.close()
...
def showcolorcircle(c=0.12, sscale=2.6, numStim=8):  # show the color circle
    ...
    winM = visual.Window(size=[800, 800], allowGUI=True, bpc=(10, 10, 10), depthBits=10, colorSpace="rgb", color=Crgb)
